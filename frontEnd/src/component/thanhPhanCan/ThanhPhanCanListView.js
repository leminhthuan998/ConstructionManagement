...
class ThanhPhanCanListView extends Component {
  constructor(props) {
    super(props);
    const me = this
    this.state = {
  ...
  loadData() {
    ...
    Axios.get(AppUtil.GLOBAL_API_PATH + API_THANH_PHAN_CAN_DETAIL)
      .then(res => {
...
export default connect(mapStateToProps)(ThanhPhanCanListView);
